...
void ui_event_Screen1(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_SCREEN_LOADED) {
        _ui_screen_change(&ui_Screen2, LV_SCR_LOAD_ANIM_FADE_ON, 2500, 50, &ui_Screen2_screen_init);
...
void ui_event_Arc1(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_VALUE_CHANGED) {
        _ui_arc_set_text_value(ui_Speed, target, "", "mph");
    }
}
void ui_event_Arc2(lv_event_t * e)
{
...
void ui_event_Arc3(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_VALUE_CHANGED) {
        _ui_arc_set_text_value(ui_battery, target, "", "%");
    }
}
void ui_event_Button7(lv_event_t * e)
{
